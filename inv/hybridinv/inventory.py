...
def example_inventory():
    # code here:
    #    Examples: pandas logic that goes a scrapes your Oracle DBs
    #              and MongoDBs for what VMs are currently running within
    #              your cloud.
                   
    #              send HTTPS request to infoblox to find a canidate list
    #              of devices to config with Ansible.
    return {
        'group': {
            'hosts': ['bender', 'fry'],
            'vars': {
